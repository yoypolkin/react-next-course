...
export default function Search({ placeholder }: { placeholder: string }) {
   ...
   * 4. The URL is updated without reloading the page, thanks to Next.js's client-side navigation (https://nextjs.org/learn/dashboard-app/navigating-between-pages)
   */
